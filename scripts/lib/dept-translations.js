...
module.exports = {
  ...
  hyDetails: {
    ...
    massage: {
      description: 'Մեջքի, պարանոցի և հոդերի մասաժ՝ լարվածությունը նվազեցնելու և արյան շրջանառությունը բարելավելու համար։',
      services: ['Դասական մասաժ', 'Կետային մասաժ', 'Սպորտային մասաժ']
    },
    acupuncture: {
    ...
    arthrosis: {
      ...
      services: ['Խորհրդատվություն', 'Ֆիզիոթերապիա', 'ԼՖԿ և մասաժ']
    },
    posture: {
