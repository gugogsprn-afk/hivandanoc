# ТЗ для Cursor: сайт «Առողջ ողնաշար»
...
Статический многоязычный сайт реабилитационного центра **«Առողջ ողնաշար»**.

**Главная задача:** максимально приблизить UX/UI и структуру к референсу [HSS Spine Department](https://www.hss.edu/departments/spine), **не копируя 1:1**, с фирменными цветами «Առողջ ողնաշար» и тремя языками.
...
- Бренд: **«Առողջ ողնաշար»** (Healthy Spine)
...
**Utility bar (верх):** Why Us, About «Առողջ ողնաշար», email.
...
## 11. Заглушки — что заменить на реальный контент «Առողջ ողնաշար»

| Что | Текущее | Нужно |
|-----|---------|-------|
| Адрес | «г. Ереван, ул. Примерная, д. 1» | Реальный адрес центра |
...
2. **Реальный контент «Առողջ ողնաշար»** — заменить все заглушки в `hospital.json` и `lang/*.json`
...
Это сайт «Առողջ ողնաշար», редизайн под HSS Spine.
